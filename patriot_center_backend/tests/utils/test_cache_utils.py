...
class TestLoadCache:
    ...
    @patch('patriot_center_backend.utils.cache_utils.LEAGUE_IDS', {2019: "id1", 2020: "id2", 2021: "id3"})
    ...
    @patch('patriot_center_backend.utils.cache_utils.LEAGUE_IDS', {2019: "id1", 2020: "id2"})
    ...
    @patch('patriot_center_backend.utils.cache_utils.LEAGUE_IDS', {2019: "id1", 2021: "id2", 2023: "id3"})
...
class TestSaveCache:
    ...
    def test_saves_cache_to_file_with_indentation(self):
        ...
        from patriot_center_backend.utils.cache_utils import save_cache
...
class TestGetCurrentSeasonAndWeek:
    ...
    @patch('patriot_center_backend.utils.cache_utils.fetch_sleeper_data')
    @patch('patriot_center_backend.utils.cache_utils.LEAGUE_IDS', {2024: "league_123"})
    def test_returns_current_season_and_week(self, mock_fetch, mock_datetime):
        ...
        from patriot_center_backend.utils.cache_utils import get_current_season_and_week
    ...
    @patch('patriot_center_backend.utils.cache_utils.datetime')
    @patch('patriot_center_backend.utils.cache_utils.LEAGUE_IDS', {})
