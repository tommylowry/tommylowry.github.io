...
class TestFetchSleeperData:
    ...
    @patch('patriot_center_backend.utils.sleeper_api_handler.requests.get')
    ...
    def test_constructs_correct_url(self, mock_get):
        ...
        from patriot_center_backend.utils.sleeper_api_handler import fetch_sleeper_data
        from patriot_center_backend.constants import SLEEPER_API_URL
        ...
        expected_url = f"{SLEEPER_API_URL}/league/123"
    ...
    def test_handles_http_error(self, mock_get):
        ...
        assert "Failed to fetch data from Sleeper API" in data["error"]
