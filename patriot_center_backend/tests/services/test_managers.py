...
class TestFetchStarters:
    ...
    @patch('patriot_center_backend.services.managers.STARTERS_CACHE')
    def test_returns_full_cache_when_no_filters(self, mock_cache):
        ...
        with patch('patriot_center_backend.services.managers.STARTERS_CACHE', mock_cache_data):
            result = fetch_starters(manager=None, season=None, week=None)

        # Should return the entire cache
        assert result == mock_cache_data

    @patch('patriot_center_backend.services.managers._filter_by_season_and_week')
    ...
    @patch('patriot_center_backend.services.managers._filter_by_manager')
...
class TestFilterBySeasonAndWeek:
    ...
    def test_returns_empty_when_season_not_found(self, mock_cache):
        ...
        from patriot_center_backend.services.managers import _filter_by_season_and_week
...
class TestFilterByManager:
    ...
    def test_returns_only_manager_data(self, mock_cache):
        ...
        from patriot_center_backend.services.managers import _filter_by_manager
